...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_HotkeyManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_HotkeyManager_t qt_meta_stringdata_HotkeyManager = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_HotkeyManager[] = {
...
Q_CONSTINIT const QMetaObject HotkeyManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_HotkeyManager.offsetsAndSizes,
    qt_meta_data_HotkeyManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_HotkeyManager_t,
        // Q_OBJECT / Q_GADGET
...
void *HotkeyManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HotkeyManager.stringdata0))
